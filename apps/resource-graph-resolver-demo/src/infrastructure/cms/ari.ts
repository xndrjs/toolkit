...
export const cmsEntryAri = ari("cms.entry", s.object({ id: s.string(), locale: localeKeySchema }));
export type CmsEntryResource = ReturnType<typeof cmsEntryAri>;

export const cmsAssetAri = ari("cms.asset", s.object({ id: s.string(), locale: localeKeySchema }));
