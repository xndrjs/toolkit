...
type AppNamespace = keyof ProgrammaticDemoSchema & string;

type ScopedT<Ns extends readonly AppNamespace[]> = Ns extends readonly []
  ? (namespace: never, key: never, ...args: never[]) => string
  : I18nScopeMultiForLocale<
      SchemaForNamespaces<ProgrammaticDemoSchema, Ns>,
      ParamsForNamespaces<ProgrammaticDemoSchema, ProgrammaticDemoParams, Ns>,
      ProgrammaticDemoLocale,
      ProgrammaticDemoLocale
    >["t"];
...
type I18nInjected<Ns extends readonly AppNamespace[]> = {
  t: ScopedT<Ns>;
  locale: ProgrammaticDemoLocale;
  pendingLocale?: ProgrammaticDemoLocale;
  error?: unknown;
  retry?: () => void;
};
