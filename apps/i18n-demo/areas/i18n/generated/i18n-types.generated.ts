...
export const MyProjectLocales = ["en", "en-US", "es", "es-AR", "fr", "it"] as const;
export type MyProjectLocale = (typeof MyProjectLocales)[number];

export const MyProjectDeliveryAreas = ["amer", "eu"] as const;
export type MyProjectDeliveryArea = (typeof MyProjectDeliveryAreas)[number];
