...
template: splash
hero:
  tagline: Clean Architecture primitives for fullstack TypeScript, starting from the domain model.
  actions:
...
`xndrjs` is a TypeScript toolkit for teams that want Clean Architecture without turning their application into a framework exercise.
