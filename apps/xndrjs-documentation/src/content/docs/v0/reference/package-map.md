...
| [`@xndrjs/application-resources`](/v0/application/application-resources/) | Application resource identifiers          | You want to name stale/invalidatable resources in the application layer without cache or UI coupling           |
...
| [`@xndrjs/i18n`](/v0/infrastructure/i18n/)                                | Type-safe ICU i18n (multi-namespace)      | You want codegen-typed keys/params, ICU MessageFormat, split delivery, and lazy `load({ namespaces, locale })` |
| [`@xndrjs/i18n-react`](/v0/infrastructure/i18n/react/)                    | React root + namespace gates              | You want `I18nRoot` / `withI18n` / `<I18n>` without Suspense for translation readiness                         |
