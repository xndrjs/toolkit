...
When you use [`@xndrjs/contentful-to-zod`](/latest/v0/infrastructure/contentful-to-zod/), parse and flatten at the transport boundary first, then wire the flat field schema into domain:
...
Transport schemas describe what can arrive; domain rules define what you trust. See [Contentful to Zod](/latest/v0/infrastructure/contentful-to-zod/) for the full pipeline.
