...
npx @xndrjs/contentful-to-zod \
  ...
  --environment master \
  --config ./contentful-to-zod.config.ts \
  --out ./src/generated/contentful.schemas.ts \
  --snapshot ./src/generated/content-types.json \
...
Transport schemas feed the domain; they do not replace it. See the [Zod adapter](/latest/adapters/zod/) for `zodToValidator`:
...
- [Package map](/latest/reference/package-map/) — where this package fits in the toolkit
